        ...
        <div className="auth-form" style={{
          ...
          <div style={{ animation: 'slideInUp 0.8s ease-out 0.2s both' }}>
            ...
            >
              ...
              >
                <Input
                  prefix={<MailOutlined style={{ color: isDarkMode ? '#666666' : '#999999' }} />}
              ...
              <div style={{ marginBottom: '32px' }}>
                <label style={{ cursor: 'pointer', display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                  ...
                  <Text style={{ 
                    ...
                    I agree to the{' '}
                    <Link href="/terms" style={{ color: '#667eea', textDecoration: 'none', fontWeight: '600' }}>
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link href="/privacy" style={{ color: '#667eea', textDecoration: 'none', fontWeight: '600' }}>
                      Privacy Policy
                    </Link>
                  </Text>
                </label>
        ...
        <div className="auth-visual" style={{
          ...
          <div style={{
            ...
            <Paragraph style={{ 
              ...
              Join thousands of users who have found their perfect home through our trusted platform
            </Paragraph>
          </div>
